...
safe_repo="$safe_parent/ad9173_dac_only_safe_${USER:-qian}_$$"
build_root="$safe_repo/build/vivado/ad9173_dac_only"
...
exec "$vivado_bin" -mode batch -source build_dac_udp.tcl
